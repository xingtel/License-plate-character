...
void GetLeftRightPos(Mat& src,std::vector<cv::Rect>& inRect,Color color);
...
void mserCharMatchT(const Mat &src, std::vector<Mat> &match, std::vector<CPlate>& out_plateVec_blue, std::vector<CPlate>& out_plateVec_yellow,
