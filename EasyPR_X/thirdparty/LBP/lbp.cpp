...
void libfeature::olbp(InputArray src, OutputArray dst) {
...
void libfeature::varlbp(InputArray src, OutputArray dst, int radius, int neighbors) {
  switch (src.getMat().type()) {
...
void libfeature::elbp0(const Mat& src, Mat& dst, int radius, int neighbors) {
  switch (src.type()) {
...
void libfeature::elbp(InputArray src, OutputArray dst, int radius, int neighbors) {
  switch (src.type()) {
...
Mat libfeature::spatial_histogram(InputArray _src, int numPatterns, int grid_x, int grid_y, bool normed) {
  Mat src = _src.getMat();
...
//------------------------------------------------------------------------------
Mat libfeature::olbp(InputArray src) {
  Mat dst;
  olbp(src, dst);
  return dst;
}

Mat libfeature::elbp(InputArray src, int radius, int neighbors) {
  Mat dst;
  elbp(src, dst, radius, neighbors);
  return dst;
}

Mat libfeature::varlbp(InputArray src, int radius, int neighbors) {
  Mat dst;
